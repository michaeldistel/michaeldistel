...
- [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) — Curated ecosystem index for OpenCode plugins, themes, agents, projects, and resources with contributor PR flows; strong distribution surface for what is actually shipping around OpenCode, though curation quality and security posture still vary by linked third-party repos. 🟩 [OSS] 🟦 [Popular]
